 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<p id="page-intro">REFERANS ISLEMLERI</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>REFERANS ISLEMLERI</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">REFERANS LISTELERI</a></li> <!-- href must be unique and match the id of target div -->
						<li><a href="#tab2">REFERANS EKLE</a></li>
					</ul>
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->					
						<table>							
							<thead>
                            	...
                            	<?php 
								$sayfada = 10;
								$sorgu = mysql_query('SELECT COUNT(*) AS toplam FROM tbl_referans_logo order by referans_logo_id desc');
								...
								$sorgu = mysql_query('SELECT * FROM tbl_referans_logo LIMIT ' . $limit . ', ' . $sayfada);
								while($row = mysql_fetch_assoc($sorgu)){	
								?>
								<tr>
									<td><?php echo $row["referans_link"]; ?></td>
									<td><?php echo $row["referans_baslik"]; ?></td>
									<td><?php echo $row["referans_logo"]; ?></td>
									<td><img width="80" height="60"  src="referans_logo/<?php echo $row["referans_logo"]; ?>"></td>
									<td>
										<!-- Icons -->
										 <a href="referans_sil.php?sayfa=<?php echo $row["referans_logo_id"];?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
									</td>
								</tr>
								<?php } ?>
