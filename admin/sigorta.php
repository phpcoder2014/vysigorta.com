 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<p id="page-intro">MÜŞTERİ ISLEMLERI</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>MÜŞTERİ ISLEMLERI</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">MÜŞTERİ LISTELERI</a></li> <!-- href must be unique and match the id of target div -->
						<li><a href="#tab2">MÜŞTERİ EKLE</a></li>
					</ul>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->					
						<table>							
							<thead>
                            	...
                            	<?php 
								$sayfada = 10;
								$sorgu = mysql_query('SELECT COUNT(*) AS toplam FROM tbl_yorumlar order by yorum_id desc');
								...
								$sorgu = mysql_query('SELECT * FROM tbl_yorumlar LIMIT ' . $limit . ', ' . $sayfada);
								while($row = mysql_fetch_assoc($sorgu)){	
								?>
								<tr>
									<td><?php echo $row["yorum_id"]; ?></td>
									<td><?php echo $row["yorum_baslik"]; ?></td>
									<td><?php echo $row["yorum_text"]; ?></td>
									<td><?php echo $row["yorum_zaman"]; ?></td>								
									<td>
										<!-- Icons -->
										 <a href="yorum_sil.php?sayfa=<?php echo $row["yorum_id"];?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
									</td>
								</tr>
								<?php } ?>
					...
					<div class="tab-content" id="tab2">
						...
						<form action="yorum_yukle.php" method="post">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->						
								<p>
									<label>Müşteri başlık buraya giriniz..</label>
									<input class="text-input large-input" placeholder="başlık giriniz" type="text" id="large-input" name="referans_link" />
								</p>								
								
								<p>
									<label>Müşteri detay buraya giriniz..</label>
									<input class="text-input large-input" placeholder="detay giriniz" type="text" id="large-input" name="referans_baslik" />
								</p>								
															
								<p>
									<input class="button" type="submit" value="Yorum Ekle" />
								</p>
