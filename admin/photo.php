 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<p id="page-intro">FOTOĞRAF ISLEMLERI</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3>FOTOĞRAF ISLEMLERI</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">FOTO LISTE</a></li> <!-- href must be unique and match the id of target div -->
						<li><a href="#tab2">FOTO EKLE</a></li>
					</ul>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->					
						<table>							
							<thead>
                            	...
                            	<?php 
								$sayfada = 10;
								$sorgu = mysql_query('SELECT COUNT(*) AS toplam FROM tbl_fotograf order by foto_id desc');
								...
								$sorgu = mysql_query('SELECT * FROM tbl_fotograf LIMIT ' . $limit . ', ' . $sayfada);
								while($row = mysql_fetch_assoc($sorgu)){	
								?>
								<tr>
									<td><?php echo $row["foto_id"]; ?></td>
									<td><?php echo $row["foto_resim"]; ?></td>
									<td><?php echo $row["foto_text"]; ?></td>
									<td><?php echo $row["foto_zaman"]; ?></td>
									<td><img width="80" height="60"  src="photo/<?php echo $row["foto_resim"]; ?>"></td>
									<td>
										<!-- Icons -->
										 <a href="foto_sil.php?sayfa=<?php echo $row["foto_id"];?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
									</td>
								</tr>
								<?php } ?>
					...
					<div class="tab-content" id="tab2">
						...
						<form action="photo_yukle.php" method="post" enctype="multipart/form-data">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->						
								<p>
									<label>Foto açıklamasını buraya giriniz..</label>
									<input class="text-input large-input" placeholder="Açıklama giriniz" type="text" id="large-input" name="referans_link" />
								</p>								
																						
								<p>
									<label>Fotoğraf resmini seciniz..</label>
									<input class="text-input large-input" placeholder="referans logosunu seçin.." type="file" id="large-input" name="import" />
								</p>
															
								<p>
									<input class="button" type="submit" value="Resmi Ekle" />
								</p>
